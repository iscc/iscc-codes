...
!!! warning "Archived draft"

    This document is an **out of date** early draft, retained for historical reference only. For the current ISCC specification see the **[Specification page](../specification.md)**, which points to [ISO 24138:2024](https://www.iso.org/standard/77899.html) and the community [ISCC Enhancement Proposals](https://ieps.iscc.codes). For implementation guidance see [iscc-core](https://github.com/iscc/iscc-core) and [iscc-sdk](https://github.com/iscc/iscc-sdk).
...
See also: [Meta-Code reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L19)
...
See also: [Content-Code-Text reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L54)
...
See also: [Content-Code-Image reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L81)
...
See also: [Content-Code-Mixed reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L102)
...
See also: [Data-Code reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L123)
...
See also: [Instance-Code reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L144)
...
!!! example "ISCC Embedding"
    ...
    We can embed the following combination of components from the [markdown version](https://github.com/iscc/iscc-codes/edit/main/docs/specification.md) of this document into the document itself because adding or removing them has no side effect:
...
See also: [Base-ISCC Encoding reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L476)
...
See also: [Base-ISCC Decoding reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L496)
...
See also: [Text trimming reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L175)
...
See also: [Text normalization reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L180)
...
See also: [Image normalization reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L217)
...
See also: [Minimum hash reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L263)
...
See also: [Image hash reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L274)
...
See also: [CDC reference code](https://github.com/iscc/iscc-codes/blob/main/src/iscc/iscc.py#L334)

## Conformance Testing

An application that claims ISCC conformance MUST pass all required functions from the ISCC conformance test suite. The test suite is available as JSON data in our [Github Repository](https://raw.githubusercontent.com/iscc/iscc-codes/main/tests/test_data.json). Test data is structured as follows:
